...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['addProject'])) {
        ...
        $sql = "INSERT INTO projects (ProjectID, ProjectName, ProjectCost, ProjectType, ProjectDate) 
                VALUES (?, ?, ?, ?, ?)";
        ...
        if ($stmt === false) {
            ...
            $stmt->bind_param("isdss", $project_id, $project_name, $project_cost, $project_type, $project_date);

            // Execute the query
            if ($stmt->execute()) {
                $success = "Project added successfully!";
                header("Location: projectview.php"); // Redirect to project view page
            } else {
...
<div class="container">
    ...
    <form action="projectadd.php" method="post">
        ...
        <input type="number" id="project_cost" name="project_cost" step="0.01" required>
