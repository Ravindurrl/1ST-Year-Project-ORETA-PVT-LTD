...
<body>
    ...
    <div class="container">
    <h1>Budget and Investment Management</h1>
        ...
        <tbody id="budgetList">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row['Invest_Amount'] . "</td>";
                    echo "<td>" . $row['Invest_Date'] . "</td>";
                    echo "<td>
                            <button onclick=\"window.location.href='bugtupdate.php?id=" . $row['Budget_id'] . "'\">Edit</button>
                            <button onclick=\"if(confirm('Are you sure you want to delete this budget?')) window.location.href='bugtdelete.php?id=" . $row['Budget_id'] . "';\">Delete</button>
                          </td>";
                    echo "</tr>";
                }
            } else {
    ...
    <button onclick="window.location.href='bugtadd.php'" style="padding: 10px 20px; background-color: white; color: black; border: none; border-radius: 5px; cursor: pointer; transition: background-color 0.3s ease, transform 0.2s ease;">
        Add New Budget
    </button>
</div>
