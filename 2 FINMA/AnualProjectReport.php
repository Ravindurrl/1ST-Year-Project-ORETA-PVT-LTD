...
$sql = "SELECT ProjectID, ProjectName, ProjectCost, ProjectType, ProjectDate 
        FROM projects 
        WHERE YEAR(ProjectDate) = YEAR(CURRENT_DATE)"; 
...
<head>
    ...
    <title>Annual Project Report</title>
        ...
        <table id="projectReportTable">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='5'>No project data found for this year</td></tr>";
                }
                ?>
            </tbody>
        </table>
