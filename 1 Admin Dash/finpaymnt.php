...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-links">
            <li><a href="paymnt.html">Payment Management</a></li>
            <li><a href="bugt.html">Budget & Investment</a></li>
            <li><a href="project.html">Calculate Project Cost</a></li>
            <li><a href="#report-generation">Generate Project Report</a></li>
            <li><a href="deliverycst.html">Calculate Delivery Cost</a></li>
            <li><a href="salary.html">Calculate Employee Salary</a></li>
        </ul>
        <!-- Logout Button -->
